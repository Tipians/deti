...
$res = mysqli_query($link, "SELECT * FROM product WHERE category_id = 'Wings'");
...
if (isset($_GET['sort'])) {
    $sort_type = $_GET['sort'];
    if ($sort_type == 'asc') {
        $res = mysqli_query($link, "SELECT * FROM product WHERE category_id = 'Wings' ORDER BY productprice ASC");
    } elseif ($sort_type == 'desc') {
        $res = mysqli_query($link, "SELECT * FROM product WHERE category_id = 'Wings' ORDER BY productprice DESC");
    } else {
        $res = mysqli_query($link, "SELECT * FROM product WHERE category_id = 'Wings'");
    }
} else {
